...
BEGIN OS
 ...
 PARAMETER bootargs = console=ttyPS0,115200 root=/dev/mmcblk1p2 ro rootwait
 PARAMETER console_device = psu_uart_0
 PARAMETER dt_setbaud = 115200
 PARAMETER dtg_alias = true
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = rs485_axi_uart16550_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartns
 PARAMETER HW_INSTANCE = rs485_axi_uart16550_1
END
